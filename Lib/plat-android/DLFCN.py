...
# Modified to include Android values
# and exclude non-android flags
RTLD_LAZY = 1
RTLD_NOW = 0
...
# additional values in Android dlfcn.h
RTLD_DEFAULT ((void*) 0xffffffff)
RTLD_NEXT    ((void*) 0xfffffffe)
